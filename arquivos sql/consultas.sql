...
WHERE prod.nroControle = produto_id -- tem que substituir o produto_id pelo nroControle que se quer pesquisar. %s está como holder somente
ORDER BY h.dataHora DESC;

/*
desempenho_recompensa
...
/*
empresas_transportaram_todos_tipos_produto
...
Essa query implementa a divisão relacional
*/
...
/*
ranking_eficiencia_empresa_tipo
